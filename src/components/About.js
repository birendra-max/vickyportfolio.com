          ...
          <div className="flex flex-col w-full 2xl:w-2/3">
            ...
            <div className="flex-1 rounded-lg shadow-xl mt-4 p-8 backdrop-filter backdrop-blur-none backdrop-saturate-150 bg-opacity-75 border border-gray-300 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
                <img id="imgskills" src="https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Ft1.daumcdn.net%2Fcfile%2Ftistory%2F998EFA4B5ABB7E9F0B" className="backdrop-filter backdrop-blur-none backdrop-saturate-150 bg-opacity-75 border border-gray-300 rounded-lg shadow-md p-2" alt="html" title="HTML"/>
