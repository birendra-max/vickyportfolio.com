    ...
    return (
        <div>
            <div className="max-w-screen-20xl mx-auto px-2 py-12 sm:px-6 lg:py-16 lg:px-2">
                <div className="px-6 py-6 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center bg-blue-700">
                    ...
                    <div className="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
                        <div id="mc_embed_signup">
                            <form className="sm:flex">
                                <input className="required rounded-md w-full px-4 py-2 email text-black" id="mce-EMAIL" placeholder="Enter your email" required="" type="email" aria-required="true" />
