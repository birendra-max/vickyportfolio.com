                    ...
                    <div className="flex flex-col w-full 2xl:w-2/3">
                        <div className="flex-1 rounded-lg shadow-xl p-8 backdrop-filter backdrop-blur-none backdrop-saturate-150 bg-opacity-75 border border-gray-300 rounded-lg shadow-md">
                            ...
                            <a
                                href={Cv}
                                download={true}
                                class="inline-flex text-sm font-medium mt-10 px-4 py-2 tracking-wide bg-green-500 rounded shadow ripple"
                            >
                            ...
                            <a
                                href={Cv}
                                download={true}
                                class="ml-4 inline-flex text-sm text-white font-medium mt-10 px-4 py-2 tracking-wide bg-blue-600 hover:bg-blue-700 rounded shadow ripple"
                            >
                                <span class="ml-2">View My CV </span>
                        ...
                        <div className="flex-1 rounded-lg shadow-xl mt-4 p-8 backdrop-filter backdrop-blur-none backdrop-saturate-150 bg-opacity-75 border border-gray-300 rounded-lg shadow-md">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
                                <div className="px-6 py-6 backdrop-filter backdrop-blur-none backdrop-saturate-150 bg-opacity-75 border border-gray-300 rounded-lg shadow-md">
                                ...
                                <div className="px-6 py-6 bg-gray-100 backdrop-filter backdrop-blur-none backdrop-saturate-150 bg-opacity-75 border border-gray-300 rounded-lg shadow-md">
                                    <div className="flex items-center justify-between">
