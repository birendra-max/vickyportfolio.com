...
export default function Nav() {
    ...
    return (
        <>
            <BrowserRouter>
                <div id="nav" className="w-full bg-teal-400 dark:bg-green-400 dark:text-black text-black">
                    <header className="lg:px-16 px-4 flex flex-wrap items-center py-4 shadow-lg h-full">
