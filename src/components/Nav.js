                        ...
                        <div
                            ...
                            <nav>
                                <ul className="md:flex items-center justify-between text-base text-gray-100 dark:text-gray-600 pt-4 md:pt-0">
                                    <li>
                                        <Link className="dark:text-white font-semibold	md:w-full w-28 pl-4 md:p-4 py-2 px-0 block hover:animate-pulse hover:text-black hover:bg-blue-200 round-full" to="/">Home</Link>
                                    </li>
                                    <li>
                                        <Link className="dark:text-white font-semibold	md:w-full w-28 pl-4 md:p-4 py-2 px-0 block hover:animate-pulse hover:text-black hover:bg-red-200 " to="/Blogs">Blogs</Link>
                                    </li>
                                    <li>
                                        <Link className="dark:text-white font-semibold	md:w-full w-28 pl-4 md:p-4 py-2 px-0 block hover:animate-pulse hover:text-black hover:bg-orange-200" to="/Projects">Projects</Link>
                                    </li>
                                    <li>
                                        <Link className="dark:text-white font-semibold	md:w-full w-28 pl-4 md:p-4 py-3 px-0 block md:mb-0 mb-2 hover:animate-pulse hover:text-black hover:bg-green-200" to="/Contact">Contact</Link>
                                    </li>
                                </ul>
                            </nav>
                        </div>
